...
import { getStatusColor } from "~/services/getPassStatusService";
...
export async function clientLoader({ request }: Route.ClientLoaderArgs) {
  try {
    ...
    const status = url.searchParams.get("status") ?? "dsa_approved";
...
export default function CSOPassRequests({ loaderData }: Route.ComponentProps) {
  ...
  const statusFilter = searchParams.get("status") ?? "dsa_approved";
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-center">
        <DashboardHeaders
          ...
          subText="Review and give final approval on DSA-forwarded pass requests"
        />
            ...
            <div className="sm:w-52">
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="dsa_approved">Awaiting CSO Review</SelectItem>
                  <SelectItem value="cso_approved">CSO Approved</SelectItem>
                  <SelectItem value="pending">Pending DSA</SelectItem>
        ...
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          {isLoadingDetails ? (
            ...
            <div className="space-y-6 py-4">
                          ...
                          {(selectedRequest?.dsa_approved_by ||
                            ...
                            <div className="flex items-start gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                  Forwarded to CSO for final approval.
                                </p>
                                {selectedRequest.dsa_approved_at && (
                                  <p className="text-xs text-muted-foreground mt-1">
                                    {new Date(
                          ...
                          selectedRequest?.cso_approved_at ? (
                            <div className="flex items-start gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                  Final approval granted. Student may download
                                  their pass.
                                </p>
                                {selectedRequest.cso_approved_at && (
                                  <p className="text-xs text-muted-foreground mt-1">
                            ...
                            <div className="flex items-start gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-sm text-muted-foreground">
                                  This pass is pending your review.
                                </p>
                              </div>
                            </div>
                          )}
              ...
              {fullPassDetails.status === "dsa_approved" && (
                <>
                  <Separator />
